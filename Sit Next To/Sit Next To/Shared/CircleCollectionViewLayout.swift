...
final class CircleCollectionViewLayout: UICollectionViewLayout {
    ...
    private let layoutInsets = UIEdgeInsets(top: 16, left: 16, bottom: 8, right: 16)
    private let itemSize = CGSize(width: 70, height: 65)
    ...
    override func prepare() {
        ...
        layoutCircleFrame = CGRect(origin: .zero, size: collectionViewContentSize)
            ...
            .insetBy(dx: itemSize.width / 3.0, dy: itemSize.height / 3.0)
